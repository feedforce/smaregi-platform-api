...
pub struct GetLayawayById {
    ...
    pub guest_numbers_unknown: Option<serde_json::Value>,
...
impl GetLayawayById {
    pub fn new(transaction_head_id: String, transaction_head_division: crate::models::TransactionHeadDivision, subtotal: String, total: String, terminal_tran_date_time: String, return_sales: crate::models::ReturnSales) -> GetLayawayById {
        GetLayawayById {
            transaction_head_id,
