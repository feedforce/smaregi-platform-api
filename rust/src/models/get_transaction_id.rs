...
pub struct GetTransactionId {
    ...
    pub details: Option<Vec<crate::models::TransactionDetail>>,
    ...
    pub coupons: Option<Vec<crate::models::CouponsForTransactions>>,
    #[serde(rename = "couponItems", skip_serializing_if = "Option::is_none")]
    pub coupon_items: Option<Vec<crate::models::CouponItemsForTransactions>>,
    ...
    #[serde(rename = "customerGroups", skip_serializing_if = "Option::is_none")]
    pub customer_groups: Option<Vec<crate::models::CustomerGroup>>,
    #[serde(rename = "staff", skip_serializing_if = "Option::is_none")]
    pub staff: Option<Box<crate::models::Staff>>,
...
impl GetTransactionId {
    pub fn new(transaction_head_id: String, transaction_head_division: crate::models::TransactionHeadDivision, terminal_tran_date_time: String, return_sales: crate::models::ReturnSales) -> GetTransactionId {
        GetTransactionId {
            transaction_head_id,
