...
impl GetLayawayListItem {
    pub fn new(transaction_head_id: String, transaction_head_division: crate::models::TransactionHeadDivision, subtotal: String, total: String, terminal_tran_date_time: String, return_sales: crate::models::ReturnSales) -> GetLayawayListItem {
        GetLayawayListItem {
            transaction_head_id,
