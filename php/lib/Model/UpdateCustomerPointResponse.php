...
/**
 * UpdateCustomerPointResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCustomerPointResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateCustomerPointResponse';
     ...
     * Sets customer_id
     *
     * @param string|null $customer_id 会員ID
     *
     * @return self
     */
    public function setCustomerId($customer_id)
    {
        ...
        if (!is_null($customer_id) && (mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling UpdateCustomerPointResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMile($mile)
    {
        ...
        if (!is_null($mile) && (mb_strlen($mile) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mile when calling UpdateCustomerPointResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPoint($point)
    {
        ...
        if (!is_null($point) && (mb_strlen($point) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point when calling UpdateCustomerPointResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $point_expire_date ポイント失効予定日：会員必須項目設定で必須項目に設定されている場合必須
     *
     * @return self
     */
    public function setPointExpireDate($point_expire_date)
    {
        ...
        if (!is_null($point_expire_date) && (mb_strlen($point_expire_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point_expire_date when calling UpdateCustomerPointResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets upd_date_time
     *
     * @param string|null $upd_date_time 更新日時：登録時・更新時の日時。[YYYY-MM-DDThh:mm:ssTZD]
     *
     * @return self
     */
    public function setUpdDateTime($upd_date_time)
    {
        ...
        if (!is_null($upd_date_time) && (mb_strlen($upd_date_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $upd_date_time when calling UpdateCustomerPointResponse., must be bigger than or equal to 1.');
        }
