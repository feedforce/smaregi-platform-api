...
/**
 * UpdateStoreResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateStoreResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateStoreResponse';
    ...
    protected static $openAPITypes = [
        ...
        'receipt_print_info' => '\OpenAPI\Client\Model\UpdateStoreResponseReceiptPrintInfo'
    ];
    ...
    public function setStoreId($store_id)
    {
        ...
        if ((mb_strlen($store_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_id when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setStoreCode($store_code)
    {
        ...
        if (!is_null($store_code) && (mb_strlen($store_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_code when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setStoreName($store_name)
    {
        ...
        if (!is_null($store_name) && (mb_strlen($store_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_name when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setStoreAbbr($store_abbr)
    {
        ...
        if (!is_null($store_abbr) && (mb_strlen($store_abbr) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_abbr when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPrintReceiptStoreName($print_receipt_store_name)
    {
        ...
        if (!is_null($print_receipt_store_name) && (mb_strlen($print_receipt_store_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $print_receipt_store_name when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPrintStockReceiptStoreName($print_stock_receipt_store_name)
    {
        ...
        if (!is_null($print_stock_receipt_store_name) && (mb_strlen($print_stock_receipt_store_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $print_stock_receipt_store_name when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPostCode($post_code)
    {
        ...
        if (!is_null($post_code) && (mb_strlen($post_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $post_code when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress($address)
    {
        ...
        if (!is_null($address) && (mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setFaxNumber($fax_number)
    {
        ...
        if (!is_null($fax_number) && (mb_strlen($fax_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fax_number when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMailAddress($mail_address)
    {
        ...
        if (!is_null($mail_address) && (mb_strlen($mail_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mail_address when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setHomepage($homepage)
    {
        ...
        if (!is_null($homepage) && (mb_strlen($homepage) < 1)) {
            throw new \InvalidArgumentException('invalid length for $homepage when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setTempTranMailAddress($temp_tran_mail_address)
    {
        ...
        if (!is_null($temp_tran_mail_address) && (mb_strlen($temp_tran_mail_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $temp_tran_mail_address when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setPriceChangeFlag($price_change_flag)
    {
        ...
        if (!is_null($price_change_flag) && (mb_strlen($price_change_flag) < 1)) {
            throw new \InvalidArgumentException('invalid length for $price_change_flag when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets sell_division
     *
     * @param float|null $sell_division sell_division
     *
     * @return self
     */
     ...
     *
     * @param float|null $sum_proc_division sum_proc_division
     *
     * @return self
     */
    ...
    public function setSumDateChangeTime($sum_date_change_time)
    {
        ...
        if (!is_null($sum_date_change_time) && (mb_strlen($sum_date_change_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sum_date_change_time when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
     ...
     * Sets sum_ref_column
     *
     * @param float|null $sum_ref_column sum_ref_column
     *
     * @return self
     */
     ...
     *
     * @param float|null $point_not_applicable point_not_applicable
     *
     * @return self
     */
     ...
     *
     * @param float|null $tax_free_division tax_free_division
     *
     * @return self
     */
    ...
    public function setMaxBundleProductCount($max_bundle_product_count)
    {
        ...
        if (!is_null($max_bundle_product_count) && (mb_strlen($max_bundle_product_count) < 1)) {
            throw new \InvalidArgumentException('invalid length for $max_bundle_product_count when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxDiscountRate($max_discount_rate)
    {
        ...
        if (!is_null($max_discount_rate) && (mb_strlen($max_discount_rate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $max_discount_rate when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float|null $carriage_display_flag carriage_display_flag
     *
     * @return self
     */
     ...
     *
     * @param float|null $terminal_adjustment_cash_flag terminal_adjustment_cash_flag
     *
     * @return self
     */
     ...
     *
     * @param float|null $terminal_check_cash_flag terminal_check_cash_flag
     *
     * @return self
     */
     ...
     *
     * @param float|null $waiter_adjustment_division waiter_adjustment_division
     *
     * @return self
     */
     ...
     *
     * @param float|null $saving_auto_division saving_auto_division
     *
     * @return self
     */
    ...
    public function setSavingAutoPrice($saving_auto_price)
    {
        ...
        if (!is_null($saving_auto_price) && (mb_strlen($saving_auto_price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $saving_auto_price when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float|null $cancel_setting_division cancel_setting_division
     *
     * @return self
     */
    ...
    public function setRoundingDivision($rounding_division)
    {
        ...
        if (!is_null($rounding_division) && (mb_strlen($rounding_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rounding_division when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float|null $discount_rounding_division discount_rounding_division
     *
     * @return self
     */
     ...
     *
     * @param float|null $card_company_select_division card_company_select_division
     *
     * @return self
     */
    ...
    public function setGiftReceiptValidDays($gift_receipt_valid_days)
    {
        ...
        if (!is_null($gift_receipt_valid_days) && (mb_strlen($gift_receipt_valid_days) < 1)) {
            throw new \InvalidArgumentException('invalid length for $gift_receipt_valid_days when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxLabelNormal($tax_label_normal)
    {
        ...
        if (!is_null($tax_label_normal) && (mb_strlen($tax_label_normal) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_label_normal when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxLabelReduce($tax_label_reduce)
    {
        ...
        if (!is_null($tax_label_reduce) && (mb_strlen($tax_label_reduce) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_label_reduce when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplaySequence($display_sequence)
    {
        ...
        if (!is_null($display_sequence) && (mb_strlen($display_sequence) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_sequence when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setFacePaymentUseDivision($face_payment_use_division)
    {
        ...
        if (!is_null($face_payment_use_division) && (mb_strlen($face_payment_use_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $face_payment_use_division when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setInsDateTime($ins_date_time)
    {
        ...
        if (!is_null($ins_date_time) && (mb_strlen($ins_date_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ins_date_time when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setUpdDateTime($upd_date_time)
    {
        ...
        if (!is_null($upd_date_time) && (mb_strlen($upd_date_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $upd_date_time when calling UpdateStoreResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\UpdateStoreResponseReceiptPrintInfo|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\UpdateStoreResponseReceiptPrintInfo|null $receipt_print_info receipt_print_info
     *
     * @return self
     */
