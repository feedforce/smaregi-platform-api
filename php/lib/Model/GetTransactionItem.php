...
/**
 * GetTransactionItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactionItem';
    ...
    public function setTransactionHeadId($transaction_head_id)
    {
        ...
        if ((mb_strlen($transaction_head_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $transaction_head_id when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTransactionDateTime($transaction_date_time)
    {
        ...
        if (!is_null($transaction_date_time) && (mb_strlen($transaction_date_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $transaction_date_time when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setUnitNonDiscountsubtotal($unit_non_discountsubtotal)
    {
        ...
        if (!is_null($unit_non_discountsubtotal) && (mb_strlen($unit_non_discountsubtotal) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unit_non_discountsubtotal when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setUnitDiscountsubtotal($unit_discountsubtotal)
    {
        ...
        if (!is_null($unit_discountsubtotal) && (mb_strlen($unit_discountsubtotal) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unit_discountsubtotal when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setUnitStaffDiscountsubtotal($unit_staff_discountsubtotal)
    {
        ...
        if (!is_null($unit_staff_discountsubtotal) && (mb_strlen($unit_staff_discountsubtotal) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unit_staff_discountsubtotal when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setUnitBargainDiscountsubtotal($unit_bargain_discountsubtotal)
    {
        ...
        if (!is_null($unit_bargain_discountsubtotal) && (mb_strlen($unit_bargain_discountsubtotal) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unit_bargain_discountsubtotal when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSubtotal($subtotal)
    {
        ...
        if (!is_null($subtotal) && (mb_strlen($subtotal) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subtotal when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSubtotalForDiscount($subtotal_for_discount)
    {
        ...
        if (!is_null($subtotal_for_discount) && (mb_strlen($subtotal_for_discount) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subtotal_for_discount when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSubtotalDiscountPrice($subtotal_discount_price)
    {
        ...
        if (!is_null($subtotal_discount_price) && (mb_strlen($subtotal_discount_price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subtotal_discount_price when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSubtotalDiscountRate($subtotal_discount_rate)
    {
        ...
        if (!is_null($subtotal_discount_rate) && (mb_strlen($subtotal_discount_rate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subtotal_discount_rate when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSubtotalDiscountDivision($subtotal_discount_division)
    {
        ...
        if (!is_null($subtotal_discount_division) && (mb_strlen($subtotal_discount_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subtotal_discount_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setPointDiscount($point_discount)
    {
        ...
        if (!is_null($point_discount) && (mb_strlen($point_discount) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point_discount when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCouponDiscount($coupon_discount)
    {
        ...
        if (!is_null($coupon_discount) && (mb_strlen($coupon_discount) < 1)) {
            throw new \InvalidArgumentException('invalid length for $coupon_discount when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTotal($total)
    {
        ...
        if (!is_null($total) && (mb_strlen($total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxInclude($tax_include)
    {
        ...
        if (!is_null($tax_include) && (mb_strlen($tax_include) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_include when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxExclude($tax_exclude)
    {
        ...
        if (!is_null($tax_exclude) && (mb_strlen($tax_exclude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_exclude when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setRoundingDivision($rounding_division)
    {
        ...
        if (!is_null($rounding_division) && (mb_strlen($rounding_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rounding_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setRoundingPrice($rounding_price)
    {
        ...
        if (!is_null($rounding_price) && (mb_strlen($rounding_price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rounding_price when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCashTotal($cash_total)
    {
        ...
        if (!is_null($cash_total) && (mb_strlen($cash_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cash_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCreditTotal($credit_total)
    {
        ...
        if (!is_null($credit_total) && (mb_strlen($credit_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $credit_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setDeposit($deposit)
    {
        ...
        if (!is_null($deposit) && (mb_strlen($deposit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $deposit when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setDepositCash($deposit_cash)
    {
        ...
        if (!is_null($deposit_cash) && (mb_strlen($deposit_cash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $deposit_cash when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setDepositCredit($deposit_credit)
    {
        ...
        if (!is_null($deposit_credit) && (mb_strlen($deposit_credit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $deposit_credit when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setChange($change)
    {
        ...
        if (!is_null($change) && (mb_strlen($change) < 1)) {
            throw new \InvalidArgumentException('invalid length for $change when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTipCash($tip_cash)
    {
        ...
        if (!is_null($tip_cash) && (mb_strlen($tip_cash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tip_cash when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTipCredit($tip_credit)
    {
        ...
        if (!is_null($tip_credit) && (mb_strlen($tip_credit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tip_credit when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && (mb_strlen($amount) < 1)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setReturnAmount($return_amount)
    {
        ...
        if (!is_null($return_amount) && (mb_strlen($return_amount) < 1)) {
            throw new \InvalidArgumentException('invalid length for $return_amount when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCostTotal($cost_total)
    {
        ...
        if (!is_null($cost_total) && (mb_strlen($cost_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cost_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSalesHeadDivision($sales_head_division)
    {
        ...
        if (!is_null($sales_head_division) && (mb_strlen($sales_head_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sales_head_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setInTaxSalesTotal($in_tax_sales_total)
    {
        ...
        if (!is_null($in_tax_sales_total) && (mb_strlen($in_tax_sales_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $in_tax_sales_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setOutTaxSalesTotal($out_tax_sales_total)
    {
        ...
        if (!is_null($out_tax_sales_total) && (mb_strlen($out_tax_sales_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $out_tax_sales_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNonTaxSalesTotal($non_tax_sales_total)
    {
        ...
        if (!is_null($non_tax_sales_total) && (mb_strlen($non_tax_sales_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $non_tax_sales_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNonSalesTargetTotal($non_sales_target_total)
    {
        ...
        if (!is_null($non_sales_target_total) && (mb_strlen($non_sales_target_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $non_sales_target_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNonSalesTargetOutTaxTotal($non_sales_target_out_tax_total)
    {
        ...
        if (!is_null($non_sales_target_out_tax_total) && (mb_strlen($non_sales_target_out_tax_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $non_sales_target_out_tax_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNonSalesTargetInTaxTotal($non_sales_target_in_tax_total)
    {
        ...
        if (!is_null($non_sales_target_in_tax_total) && (mb_strlen($non_sales_target_in_tax_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $non_sales_target_in_tax_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNonSalesTargetTaxFreeTotal($non_sales_target_tax_free_total)
    {
        ...
        if (!is_null($non_sales_target_tax_free_total) && (mb_strlen($non_sales_target_tax_free_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $non_sales_target_tax_free_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNonSalesTargetCostTotal($non_sales_target_cost_total)
    {
        ...
        if (!is_null($non_sales_target_cost_total) && (mb_strlen($non_sales_target_cost_total) < 1)) {
            throw new \InvalidArgumentException('invalid length for $non_sales_target_cost_total when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNonSalesTargetAmount($non_sales_target_amount)
    {
        ...
        if (!is_null($non_sales_target_amount) && (mb_strlen($non_sales_target_amount) < 1)) {
            throw new \InvalidArgumentException('invalid length for $non_sales_target_amount when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNonSalesTargetReturnAmount($non_sales_target_return_amount)
    {
        ...
        if (!is_null($non_sales_target_return_amount) && (mb_strlen($non_sales_target_return_amount) < 1)) {
            throw new \InvalidArgumentException('invalid length for $non_sales_target_return_amount when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNewPoint($new_point)
    {
        ...
        if (!is_null($new_point) && (mb_strlen($new_point) < 1)) {
            throw new \InvalidArgumentException('invalid length for $new_point when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSpendPoint($spend_point)
    {
        ...
        if (!is_null($spend_point) && (mb_strlen($spend_point) < 1)) {
            throw new \InvalidArgumentException('invalid length for $spend_point when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setPoint($point)
    {
        ...
        if (!is_null($point) && (mb_strlen($point) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTotalPoint($total_point)
    {
        ...
        if (!is_null($total_point) && (mb_strlen($total_point) < 1)) {
            throw new \InvalidArgumentException('invalid length for $total_point when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCurrentMile($current_mile)
    {
        ...
        if (!is_null($current_mile) && (mb_strlen($current_mile) < 1)) {
            throw new \InvalidArgumentException('invalid length for $current_mile when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setEarnMile($earn_mile)
    {
        ...
        if (!is_null($earn_mile) && (mb_strlen($earn_mile) < 1)) {
            throw new \InvalidArgumentException('invalid length for $earn_mile when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTotalMile($total_mile)
    {
        ...
        if (!is_null($total_mile) && (mb_strlen($total_mile) < 1)) {
            throw new \InvalidArgumentException('invalid length for $total_mile when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setAdjustmentMile($adjustment_mile)
    {
        ...
        if (!is_null($adjustment_mile) && (mb_strlen($adjustment_mile) < 1)) {
            throw new \InvalidArgumentException('invalid length for $adjustment_mile when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setAdjustmentMileDivision($adjustment_mile_division)
    {
        ...
        if (!is_null($adjustment_mile_division) && (mb_strlen($adjustment_mile_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $adjustment_mile_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setAdjustmentMileValue($adjustment_mile_value)
    {
        ...
        if (!is_null($adjustment_mile_value) && (mb_strlen($adjustment_mile_value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $adjustment_mile_value when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setStoreId($store_id)
    {
        ...
        if (!is_null($store_id) && (mb_strlen($store_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_id when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setStoreCode($store_code)
    {
        ...
        if (!is_null($store_code) && (mb_strlen($store_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_code when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTerminalId($terminal_id)
    {
        ...
        if (!is_null($terminal_id) && (mb_strlen($terminal_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $terminal_id when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if (!is_null($customer_id) && (mb_strlen($customer_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerCode($customer_code)
    {
        ...
        if (!is_null($customer_code) && (mb_strlen($customer_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_code when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTerminalTranId($terminal_tran_id)
    {
        ...
        if (!is_null($terminal_tran_id) && (mb_strlen($terminal_tran_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $terminal_tran_id when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTerminalTranDateTime($terminal_tran_date_time)
    {
        ...
        if ((mb_strlen($terminal_tran_date_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $terminal_tran_date_time when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSumDivision($sum_division)
    {
        ...
        if (!is_null($sum_division) && (mb_strlen($sum_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sum_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setAdjustmentDateTime($adjustment_date_time)
    {
        ...
        if (!is_null($adjustment_date_time) && (mb_strlen($adjustment_date_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $adjustment_date_time when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSumDate($sum_date)
    {
        ...
        if (!is_null($sum_date) && (mb_strlen($sum_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sum_date when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerRank($customer_rank)
    {
        ...
        if (!is_null($customer_rank) && (mb_strlen($customer_rank) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_rank when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId($customer_group_id)
    {
        ...
        if (!is_null($customer_group_id) && (mb_strlen($customer_group_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_group_id when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId2($customer_group_id2)
    {
        ...
        if (!is_null($customer_group_id2) && (mb_strlen($customer_group_id2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_group_id2 when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId3($customer_group_id3)
    {
        ...
        if (!is_null($customer_group_id3) && (mb_strlen($customer_group_id3) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_group_id3 when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId4($customer_group_id4)
    {
        ...
        if (!is_null($customer_group_id4) && (mb_strlen($customer_group_id4) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_group_id4 when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerGroupId5($customer_group_id5)
    {
        ...
        if (!is_null($customer_group_id5) && (mb_strlen($customer_group_id5) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_group_id5 when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setStaffId($staff_id)
    {
        ...
        if (!is_null($staff_id) && (mb_strlen($staff_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $staff_id when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setStaffCode($staff_code)
    {
        ...
        if (!is_null($staff_code) && (mb_strlen($staff_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $staff_code when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setStaffName($staff_name)
    {
        ...
        if (!is_null($staff_name) && (mb_strlen($staff_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $staff_name when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCreditDivision($credit_division)
    {
        ...
        if (!is_null($credit_division) && (mb_strlen($credit_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $credit_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentCount($payment_count)
    {
        ...
        if (!is_null($payment_count) && (mb_strlen($payment_count) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_count when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSlipNumber($slip_number)
    {
        ...
        if (!is_null($slip_number) && (mb_strlen($slip_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slip_number when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCancelSlipNumber($cancel_slip_number)
    {
        ...
        if (!is_null($cancel_slip_number) && (mb_strlen($cancel_slip_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cancel_slip_number when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthNumber($auth_number)
    {
        ...
        if (!is_null($auth_number) && (mb_strlen($auth_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $auth_number when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthDate($auth_date)
    {
        ...
        if (!is_null($auth_date) && (mb_strlen($auth_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $auth_date when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCardCompany($card_company)
    {
        ...
        if (!is_null($card_company) && (mb_strlen($card_company) < 1)) {
            throw new \InvalidArgumentException('invalid length for $card_company when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setDenomination($denomination)
    {
        ...
        if (!is_null($denomination) && (mb_strlen($denomination) < 1)) {
            throw new \InvalidArgumentException('invalid length for $denomination when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setMemo($memo)
    {
        ...
        if (!is_null($memo) && (mb_strlen($memo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setReceiptMemo($receipt_memo)
    {
        ...
        if (!is_null($receipt_memo) && (mb_strlen($receipt_memo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $receipt_memo when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCarriage($carriage)
    {
        ...
        if (!is_null($carriage) && (mb_strlen($carriage) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carriage when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCommission($commission)
    {
        ...
        if (!is_null($commission) && (mb_strlen($commission) < 1)) {
            throw new \InvalidArgumentException('invalid length for $commission when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setGuestNumbers($guest_numbers)
    {
        ...
        if (!is_null($guest_numbers) && (mb_strlen($guest_numbers) < 1)) {
            throw new \InvalidArgumentException('invalid length for $guest_numbers when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setGuestNumbersMale($guest_numbers_male)
    {
        ...
        if (!is_null($guest_numbers_male) && (mb_strlen($guest_numbers_male) < 1)) {
            throw new \InvalidArgumentException('invalid length for $guest_numbers_male when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setGuestNumbersFemale($guest_numbers_female)
    {
        ...
        if (!is_null($guest_numbers_female) && (mb_strlen($guest_numbers_female) < 1)) {
            throw new \InvalidArgumentException('invalid length for $guest_numbers_female when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setGuestNumbersUnknown($guest_numbers_unknown)
    {
        ...
        if (!is_null($guest_numbers_unknown) && (mb_strlen($guest_numbers_unknown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $guest_numbers_unknown when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setEnterDateTime($enter_date_time)
    {
        ...
        if (!is_null($enter_date_time) && (mb_strlen($enter_date_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $enter_date_time when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxFreeSalesDivision($tax_free_sales_division)
    {
        ...
        if (!is_null($tax_free_sales_division) && (mb_strlen($tax_free_sales_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_free_sales_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNetTaxFreeGeneralTaxInclude($net_tax_free_general_tax_include)
    {
        ...
        if (!is_null($net_tax_free_general_tax_include) && (mb_strlen($net_tax_free_general_tax_include) < 1)) {
            throw new \InvalidArgumentException('invalid length for $net_tax_free_general_tax_include when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNetTaxFreeGeneralTaxExclude($net_tax_free_general_tax_exclude)
    {
        ...
        if (!is_null($net_tax_free_general_tax_exclude) && (mb_strlen($net_tax_free_general_tax_exclude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $net_tax_free_general_tax_exclude when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNetTaxFreeConsumableTaxInclude($net_tax_free_consumable_tax_include)
    {
        ...
        if (!is_null($net_tax_free_consumable_tax_include) && (mb_strlen($net_tax_free_consumable_tax_include) < 1)) {
            throw new \InvalidArgumentException('invalid length for $net_tax_free_consumable_tax_include when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNetTaxFreeConsumableTaxExclude($net_tax_free_consumable_tax_exclude)
    {
        ...
        if (!is_null($net_tax_free_consumable_tax_exclude) && (mb_strlen($net_tax_free_consumable_tax_exclude) < 1)) {
            throw new \InvalidArgumentException('invalid length for $net_tax_free_consumable_tax_exclude when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (mb_strlen($tags) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setPointGivingDivision($point_giving_division)
    {
        ...
        if (!is_null($point_giving_division) && (mb_strlen($point_giving_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point_giving_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setPointGivingUnitPrice($point_giving_unit_price)
    {
        ...
        if (!is_null($point_giving_unit_price) && (mb_strlen($point_giving_unit_price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point_giving_unit_price when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setPointGivingUnit($point_giving_unit)
    {
        ...
        if (!is_null($point_giving_unit) && (mb_strlen($point_giving_unit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point_giving_unit when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setPointSpendDivision($point_spend_division)
    {
        ...
        if (!is_null($point_spend_division) && (mb_strlen($point_spend_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point_spend_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setMileageDivision($mileage_division)
    {
        ...
        if (!is_null($mileage_division) && (mb_strlen($mileage_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mileage_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setMileageLabel($mileage_label)
    {
        ...
        if (!is_null($mileage_label) && (mb_strlen($mileage_label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mileage_label when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerPinCode($customer_pin_code)
    {
        ...
        if (!is_null($customer_pin_code) && (mb_strlen($customer_pin_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_pin_code when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setDisposeServerTransactionHeadId($dispose_server_transaction_head_id)
    {
        ...
        if (!is_null($dispose_server_transaction_head_id) && (mb_strlen($dispose_server_transaction_head_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $dispose_server_transaction_head_id when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCancelDateTime($cancel_date_time)
    {
        ...
        if (!is_null($cancel_date_time) && (mb_strlen($cancel_date_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cancel_date_time when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setSellDivision($sell_division)
    {
        ...
        if (!is_null($sell_division) && (mb_strlen($sell_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sell_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxRate($tax_rate)
    {
        ...
        if (!is_null($tax_rate) && (mb_strlen($tax_rate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_rate when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxRounding($tax_rounding)
    {
        ...
        if (!is_null($tax_rounding) && (mb_strlen($tax_rounding) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_rounding when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setDiscountRoundingDivision($discount_rounding_division)
    {
        ...
        if (!is_null($discount_rounding_division) && (mb_strlen($discount_rounding_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $discount_rounding_division when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setTransactionUuid($transaction_uuid)
    {
        ...
        if (!is_null($transaction_uuid) && (mb_strlen($transaction_uuid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $transaction_uuid when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setExchangeTicketNo($exchange_ticket_no)
    {
        ...
        if (!is_null($exchange_ticket_no) && (mb_strlen($exchange_ticket_no) < 1)) {
            throw new \InvalidArgumentException('invalid length for $exchange_ticket_no when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setGiftReceiptValidDays($gift_receipt_valid_days)
    {
        ...
        if (!is_null($gift_receipt_valid_days) && (mb_strlen($gift_receipt_valid_days) < 1)) {
            throw new \InvalidArgumentException('invalid length for $gift_receipt_valid_days when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setBarcode($barcode)
    {
        ...
        if (!is_null($barcode) && (mb_strlen($barcode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $barcode when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
    ...
    public function setUpdDateTime($upd_date_time)
    {
        ...
        if (!is_null($upd_date_time) && (mb_strlen($upd_date_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $upd_date_time when calling GetTransactionItem., must be bigger than or equal to 1.');
        }
