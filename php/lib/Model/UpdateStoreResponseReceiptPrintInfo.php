...
/**
 * UpdateStoreResponseReceiptPrintInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateStoreResponseReceiptPrintInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateStoreResponse_receiptPrintInfo';
    ...
    public function setStoreId($store_id)
    {
        ...
        if (!is_null($store_id) && (mb_strlen($store_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_id when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setHeader($header)
    {
        ...
        if (!is_null($header) && (mb_strlen($header) < 1)) {
            throw new \InvalidArgumentException('invalid length for $header when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setFooter($footer)
    {
        ...
        if (!is_null($footer) && (mb_strlen($footer) < 1)) {
            throw new \InvalidArgumentException('invalid length for $footer when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setReceiptTaxOfficeStampComment($receipt_tax_office_stamp_comment)
    {
        ...
        if (!is_null($receipt_tax_office_stamp_comment) && (mb_strlen($receipt_tax_office_stamp_comment) < 1)) {
            throw new \InvalidArgumentException('invalid length for $receipt_tax_office_stamp_comment when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setAirPrintLogo($air_print_logo)
    {
        ...
        if (!is_null($air_print_logo) && (mb_strlen($air_print_logo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $air_print_logo when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setAdvertisementImage($advertisement_image)
    {
        ...
        if (!is_null($advertisement_image) && (mb_strlen($advertisement_image) < 1)) {
            throw new \InvalidArgumentException('invalid length for $advertisement_image when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setGiftReceiptImage($gift_receipt_image)
    {
        ...
        if (!is_null($gift_receipt_image) && (mb_strlen($gift_receipt_image) < 1)) {
            throw new \InvalidArgumentException('invalid length for $gift_receipt_image when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setGiftReceiptNote($gift_receipt_note)
    {
        ...
        if (!is_null($gift_receipt_note) && (mb_strlen($gift_receipt_note) < 1)) {
            throw new \InvalidArgumentException('invalid length for $gift_receipt_note when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxOfficeName($tax_office_name)
    {
        ...
        if (!is_null($tax_office_name) && (mb_strlen($tax_office_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_office_name when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setDiscountReceiptHeader($discount_receipt_header)
    {
        ...
        if (!is_null($discount_receipt_header) && (mb_strlen($discount_receipt_header) < 1)) {
            throw new \InvalidArgumentException('invalid length for $discount_receipt_header when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
    ...
    public function setDiscountReceiptFooter($discount_receipt_footer)
    {
        ...
        if (!is_null($discount_receipt_footer) && (mb_strlen($discount_receipt_footer) < 1)) {
            throw new \InvalidArgumentException('invalid length for $discount_receipt_footer when calling UpdateStoreResponseReceiptPrintInfo., must be bigger than or equal to 1.');
        }
