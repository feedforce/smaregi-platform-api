...
class UpdateStoreRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'receipt_print_info' => '\OpenAPI\Client\Model\UpdateStoreRequestReceiptPrintInfo'
    ];
    ...
    public function setStoreCode($store_code)
    {
        ...
        if (!is_null($store_code) && (mb_strlen($store_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_code when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setStoreName($store_name)
    {
        ...
        if (!is_null($store_name) && (mb_strlen($store_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_name when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setStoreAbbr($store_abbr)
    {
        ...
        if (!is_null($store_abbr) && (mb_strlen($store_abbr) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_abbr when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPrintReceiptStoreName($print_receipt_store_name)
    {
        ...
        if (!is_null($print_receipt_store_name) && (mb_strlen($print_receipt_store_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $print_receipt_store_name when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPrintStockReceiptStoreName($print_stock_receipt_store_name)
    {
        ...
        if (!is_null($print_stock_receipt_store_name) && (mb_strlen($print_stock_receipt_store_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $print_stock_receipt_store_name when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets division
     *
     * @return \OpenAPI\Client\Model\StoreDivision|null
     */
     ...
     * Sets division
     *
     * @param \OpenAPI\Client\Model\StoreDivision|null $division division
     *
     * @return self
     */
    ...
    public function setPostCode($post_code)
    {
        ...
        if (!is_null($post_code) && (mb_strlen($post_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $post_code when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress($address)
    {
        ...
        if (!is_null($address) && (mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFaxNumber($fax_number)
    {
        ...
        if (!is_null($fax_number) && (mb_strlen($fax_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fax_number when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMailAddress($mail_address)
    {
        ...
        if (!is_null($mail_address) && (mb_strlen($mail_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mail_address when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setHomepage($homepage)
    {
        ...
        if (!is_null($homepage) && (mb_strlen($homepage) < 1)) {
            throw new \InvalidArgumentException('invalid length for $homepage when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTempTranMailAddress($temp_tran_mail_address)
    {
        ...
        if (!is_null($temp_tran_mail_address) && (mb_strlen($temp_tran_mail_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $temp_tran_mail_address when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float|null $price_change_flag price_change_flag
     *
     * @return self
     */
    ...
    public function setSumDateChangeTime($sum_date_change_time)
    {
        ...
        if (!is_null($sum_date_change_time) && (mb_strlen($sum_date_change_time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sum_date_change_time when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float|null $max_bundle_product_count max_bundle_product_count
     *
     * @return self
     */
    ...
    public function setMaxDiscountRate($max_discount_rate)
    {
        ...
        if (!is_null($max_discount_rate) && (mb_strlen($max_discount_rate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $max_discount_rate when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSavingAutoPrice($saving_auto_price)
    {
        ...
        if (!is_null($saving_auto_price) && (mb_strlen($saving_auto_price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $saving_auto_price when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRoundingDivision($rounding_division)
    {
        ...
        if (!is_null($rounding_division) && (mb_strlen($rounding_division) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rounding_division when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setGiftReceiptValidDays($gift_receipt_valid_days)
    {
        ...
        if (!is_null($gift_receipt_valid_days) && (mb_strlen($gift_receipt_valid_days) < 1)) {
            throw new \InvalidArgumentException('invalid length for $gift_receipt_valid_days when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxLabelNormal($tax_label_normal)
    {
        ...
        if (!is_null($tax_label_normal) && (mb_strlen($tax_label_normal) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_label_normal when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxLabelReduce($tax_label_reduce)
    {
        ...
        if (!is_null($tax_label_reduce) && (mb_strlen($tax_label_reduce) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_label_reduce when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplaySequence($display_sequence)
    {
        ...
        if (!is_null($display_sequence) && (mb_strlen($display_sequence) < 1)) {
            throw new \InvalidArgumentException('invalid length for $display_sequence when calling UpdateStoreRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param float|null $face_payment_use_division face_payment_use_division
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\UpdateStoreRequestReceiptPrintInfo|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\UpdateStoreRequestReceiptPrintInfo|null $receipt_print_info receipt_print_info
     *
     * @return self
     */
