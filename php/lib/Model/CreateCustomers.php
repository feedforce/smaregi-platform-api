...
/**
 * CreateCustomers Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateCustomers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createCustomers';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['customer_code']) < 1)) {
    ...
    public function setCustomerCode($customer_code)
    {
        ...
        if ((mb_strlen($customer_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_code when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setCustomerNo($customer_no)
    {
        ...
        if (!is_null($customer_no) && (mb_strlen($customer_no) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_no when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setRank($rank)
    {
        ...
        if (!is_null($rank) && (mb_strlen($rank) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rank when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setStaffRank($staff_rank)
    {
        ...
        if (!is_null($staff_rank) && (mb_strlen($staff_rank) < 1)) {
            throw new \InvalidArgumentException('invalid length for $staff_rank when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setFirstKana($first_kana)
    {
        ...
        if (!is_null($first_kana) && (mb_strlen($first_kana) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_kana when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setLastKana($last_kana)
    {
        ...
        if (!is_null($last_kana) && (mb_strlen($last_kana) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_kana when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setPostCode($post_code)
    {
        ...
        if (!is_null($post_code) && (mb_strlen($post_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $post_code when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress($address)
    {
        ...
        if (!is_null($address) && (mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setFaxNumber($fax_number)
    {
        ...
        if (!is_null($fax_number) && (mb_strlen($fax_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fax_number when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setMobileNumber($mobile_number)
    {
        ...
        if (!is_null($mobile_number) && (mb_strlen($mobile_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mobile_number when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setMailAddress($mail_address)
    {
        ...
        if (!is_null($mail_address) && (mb_strlen($mail_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mail_address when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setMailAddress2($mail_address2)
    {
        ...
        if (!is_null($mail_address2) && (mb_strlen($mail_address2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mail_address2 when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setMailAddress3($mail_address3)
    {
        ...
        if (!is_null($mail_address3) && (mb_strlen($mail_address3) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mail_address3 when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyName($company_name)
    {
        ...
        if (!is_null($company_name) && (mb_strlen($company_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setDepartmentName($department_name)
    {
        ...
        if (!is_null($department_name) && (mb_strlen($department_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $department_name when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setManagerialPosition($managerial_position)
    {
        ...
        if (!is_null($managerial_position) && (mb_strlen($managerial_position) < 1)) {
            throw new \InvalidArgumentException('invalid length for $managerial_position when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setBirthDate($birth_date)
    {
        ...
        if (!is_null($birth_date) && (mb_strlen($birth_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $birth_date when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setPointExpireDate($point_expire_date)
    {
        ...
        if (!is_null($point_expire_date) && (mb_strlen($point_expire_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point_expire_date when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setEntryDate($entry_date)
    {
        ...
        if (!is_null($entry_date) && (mb_strlen($entry_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $entry_date when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setLeaveDate($leave_date)
    {
        ...
        if (!is_null($leave_date) && (mb_strlen($leave_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $leave_date when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setPointGivingUnitPrice($point_giving_unit_price)
    {
        ...
        if (!is_null($point_giving_unit_price) && (mb_strlen($point_giving_unit_price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point_giving_unit_price when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setPointGivingUnit($point_giving_unit)
    {
        ...
        if (!is_null($point_giving_unit) && (mb_strlen($point_giving_unit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point_giving_unit when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setPinCode($pin_code)
    {
        ...
        if (!is_null($pin_code) && (mb_strlen($pin_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pin_code when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setPassportNo($passport_no)
    {
        ...
        if (!is_null($passport_no) && (mb_strlen($passport_no) < 1)) {
            throw new \InvalidArgumentException('invalid length for $passport_no when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setNationality($nationality)
    {
        ...
        if (!is_null($nationality) && (mb_strlen($nationality) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nationality when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setAlphabetName($alphabet_name)
    {
        ...
        if (!is_null($alphabet_name) && (mb_strlen($alphabet_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $alphabet_name when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setNote($note)
    {
        ...
        if (!is_null($note) && (mb_strlen($note) < 1)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setNote2($note2)
    {
        ...
        if (!is_null($note2) && (mb_strlen($note2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $note2 when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setFavoriteList($favorite_list)
    {
        ...
        if (!is_null($favorite_list) && (mb_strlen($favorite_list) < 1)) {
            throw new \InvalidArgumentException('invalid length for $favorite_list when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setBrowsingList($browsing_list)
    {
        ...
        if (!is_null($browsing_list) && (mb_strlen($browsing_list) < 1)) {
            throw new \InvalidArgumentException('invalid length for $browsing_list when calling CreateCustomers., must be bigger than or equal to 1.');
        }
    ...
    public function setStoreId($store_id)
    {
        ...
        if (!is_null($store_id) && (mb_strlen($store_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store_id when calling CreateCustomers., must be bigger than or equal to 1.');
        }
