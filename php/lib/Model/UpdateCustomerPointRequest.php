...
/**
 * UpdateCustomerPointRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCustomerPointRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateCustomerPointRequest';
    ...
    public function setMile($mile)
    {
        ...
        if (!is_null($mile) && (mb_strlen($mile) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mile when calling UpdateCustomerPointRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPoint($point)
    {
        ...
        if (!is_null($point) && (mb_strlen($point) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point when calling UpdateCustomerPointRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $point_expire_date ポイント失効予定日：指定しない場合ポイント失効日は更新されません。
     *
     * @return self
     */
    public function setPointExpireDate($point_expire_date)
    {
        ...
        if (!is_null($point_expire_date) && (mb_strlen($point_expire_date) < 1)) {
            throw new \InvalidArgumentException('invalid length for $point_expire_date when calling UpdateCustomerPointRequest., must be bigger than or equal to 1.');
        }
