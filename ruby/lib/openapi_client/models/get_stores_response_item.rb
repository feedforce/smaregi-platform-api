  ...
  class GetStoresResponseItem
    ...
    def self.openapi_types
      {
        ...
        :'point_condition' => :'PointCondition',
        :'receipt_print_info' => :'GetStoresResponseItemReceiptPrintInfo'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GetStoresResponseItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GetStoresResponseItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pause_flag')
        self.pause_flag = attributes[:'pause_flag']
      end
    ...
    def list_invalid_properties
      ...
      if !@price_change_flag.nil? && @price_change_flag.to_s.length < 1
        invalid_properties.push('invalid value for "price_change_flag", the character length must be great than or equal to 1.')
      end
      ...
      if !@sum_proc_division.nil? && @sum_proc_division.to_s.length < 1
        invalid_properties.push('invalid value for "sum_proc_division", the character length must be great than or equal to 1.')
      end
      ...
      if !@sum_ref_column.nil? && @sum_ref_column.to_s.length < 1
        invalid_properties.push('invalid value for "sum_ref_column", the character length must be great than or equal to 1.')
      end
      ...
      if !@max_bundle_product_count.nil? && @max_bundle_product_count.to_s.length < 1
        invalid_properties.push('invalid value for "max_bundle_product_count", the character length must be great than or equal to 1.')
      end
      ...
      if !@carriage_display_flag.nil? && @carriage_display_flag.to_s.length < 1
        invalid_properties.push('invalid value for "carriage_display_flag", the character length must be great than or equal to 1.')
      end

      if !@terminal_adjustment_cash_flag.nil? && @terminal_adjustment_cash_flag.to_s.length < 1
        invalid_properties.push('invalid value for "terminal_adjustment_cash_flag", the character length must be great than or equal to 1.')
      end

      if !@terminal_check_cash_flag.nil? && @terminal_check_cash_flag.to_s.length < 1
        invalid_properties.push('invalid value for "terminal_check_cash_flag", the character length must be great than or equal to 1.')
      end

      if !@waiter_adjustment_division.nil? && @waiter_adjustment_division.to_s.length < 1
        invalid_properties.push('invalid value for "waiter_adjustment_division", the character length must be great than or equal to 1.')
      end

      if !@saving_auto_division.nil? && @saving_auto_division.to_s.length < 1
        invalid_properties.push('invalid value for "saving_auto_division", the character length must be great than or equal to 1.')
      end
      ...
      if !@cancel_setting_division.nil? && @cancel_setting_division.to_s.length < 1
        invalid_properties.push('invalid value for "cancel_setting_division", the character length must be great than or equal to 1.')
      end
      ...
      if !@card_company_select_division.nil? && @card_company_select_division.to_s.length < 1
        invalid_properties.push('invalid value for "card_company_select_division", the character length must be great than or equal to 1.')
      end
      ...
      if !@pause_flag.nil? && @pause_flag.to_s.length < 1
        invalid_properties.push('invalid value for "pause_flag", the character length must be great than or equal to 1.')
      end
      ...
      if !@face_payment_use_division.nil? && @face_payment_use_division.to_s.length < 1
        invalid_properties.push('invalid value for "face_payment_use_division", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @store_id.to_s.length < 1
      return false if @store_code.nil?
      return false if @store_code.to_s.length < 1
      return false if @store_name.nil?
      return false if @store_name.to_s.length < 1
      ...
      return false if !@price_change_flag.nil? && @price_change_flag.to_s.length < 1
      return false if !@sell_division.nil? && @sell_division.to_s.length < 1
      return false if !@sum_proc_division.nil? && @sum_proc_division.to_s.length < 1
      return false if !@sum_date_change_time.nil? && @sum_date_change_time.to_s.length < 1
      return false if !@sum_ref_column.nil? && @sum_ref_column.to_s.length < 1
      ...
      return false if !@max_bundle_product_count.nil? && @max_bundle_product_count.to_s.length < 1
      return false if !@max_discount_rate.nil? && @max_discount_rate.to_s.length < 1
      return false if !@carriage_display_flag.nil? && @carriage_display_flag.to_s.length < 1
      return false if !@terminal_adjustment_cash_flag.nil? && @terminal_adjustment_cash_flag.to_s.length < 1
      return false if !@terminal_check_cash_flag.nil? && @terminal_check_cash_flag.to_s.length < 1
      return false if !@waiter_adjustment_division.nil? && @waiter_adjustment_division.to_s.length < 1
      return false if !@saving_auto_division.nil? && @saving_auto_division.to_s.length < 1
      return false if !@saving_auto_price.nil? && @saving_auto_price.to_s.length < 1
      return false if !@cancel_setting_division.nil? && @cancel_setting_division.to_s.length < 1
      ...
      return false if !@card_company_select_division.nil? && @card_company_select_division.to_s.length < 1
      ...
      return false if !@pause_flag.nil? && @pause_flag.to_s.length < 1
      return false if !@display_sequence.nil? && @display_sequence.to_s.length < 1
      return false if !@face_payment_use_division.nil? && @face_payment_use_division.to_s.length < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] price_change_flag Value to be assigned
    def price_change_flag=(price_change_flag)
      if !price_change_flag.nil? && price_change_flag.to_s.length < 1
        fail ArgumentError, 'invalid value for "price_change_flag", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] sum_proc_division Value to be assigned
    def sum_proc_division=(sum_proc_division)
      if !sum_proc_division.nil? && sum_proc_division.to_s.length < 1
        fail ArgumentError, 'invalid value for "sum_proc_division", the character length must be great than or equal to 1.'
      end

      @sum_proc_division = sum_proc_division
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] sum_ref_column Value to be assigned
    def sum_ref_column=(sum_ref_column)
      if !sum_ref_column.nil? && sum_ref_column.to_s.length < 1
        fail ArgumentError, 'invalid value for "sum_ref_column", the character length must be great than or equal to 1.'
      end

      @sum_ref_column = sum_ref_column
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] max_bundle_product_count Value to be assigned
    def max_bundle_product_count=(max_bundle_product_count)
      if !max_bundle_product_count.nil? && max_bundle_product_count.to_s.length < 1
        fail ArgumentError, 'invalid value for "max_bundle_product_count", the character length must be great than or equal to 1.'
      end

      @max_bundle_product_count = max_bundle_product_count
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] carriage_display_flag Value to be assigned
    def carriage_display_flag=(carriage_display_flag)
      if !carriage_display_flag.nil? && carriage_display_flag.to_s.length < 1
        fail ArgumentError, 'invalid value for "carriage_display_flag", the character length must be great than or equal to 1.'
      end

      @carriage_display_flag = carriage_display_flag
    end

    # Custom attribute writer method with validation
    # @param [Object] terminal_adjustment_cash_flag Value to be assigned
    def terminal_adjustment_cash_flag=(terminal_adjustment_cash_flag)
      if !terminal_adjustment_cash_flag.nil? && terminal_adjustment_cash_flag.to_s.length < 1
        fail ArgumentError, 'invalid value for "terminal_adjustment_cash_flag", the character length must be great than or equal to 1.'
      end

      @terminal_adjustment_cash_flag = terminal_adjustment_cash_flag
    end

    # Custom attribute writer method with validation
    # @param [Object] terminal_check_cash_flag Value to be assigned
    def terminal_check_cash_flag=(terminal_check_cash_flag)
      if !terminal_check_cash_flag.nil? && terminal_check_cash_flag.to_s.length < 1
        fail ArgumentError, 'invalid value for "terminal_check_cash_flag", the character length must be great than or equal to 1.'
      end

      @terminal_check_cash_flag = terminal_check_cash_flag
    end

    # Custom attribute writer method with validation
    # @param [Object] waiter_adjustment_division Value to be assigned
    def waiter_adjustment_division=(waiter_adjustment_division)
      if !waiter_adjustment_division.nil? && waiter_adjustment_division.to_s.length < 1
        fail ArgumentError, 'invalid value for "waiter_adjustment_division", the character length must be great than or equal to 1.'
      end

      @waiter_adjustment_division = waiter_adjustment_division
    end

    # Custom attribute writer method with validation
    # @param [Object] saving_auto_division Value to be assigned
    def saving_auto_division=(saving_auto_division)
      if !saving_auto_division.nil? && saving_auto_division.to_s.length < 1
        fail ArgumentError, 'invalid value for "saving_auto_division", the character length must be great than or equal to 1.'
      end

      @saving_auto_division = saving_auto_division
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] cancel_setting_division Value to be assigned
    def cancel_setting_division=(cancel_setting_division)
      if !cancel_setting_division.nil? && cancel_setting_division.to_s.length < 1
        fail ArgumentError, 'invalid value for "cancel_setting_division", the character length must be great than or equal to 1.'
      end

      @cancel_setting_division = cancel_setting_division
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] card_company_select_division Value to be assigned
    def card_company_select_division=(card_company_select_division)
      if !card_company_select_division.nil? && card_company_select_division.to_s.length < 1
        fail ArgumentError, 'invalid value for "card_company_select_division", the character length must be great than or equal to 1.'
      end

      @card_company_select_division = card_company_select_division
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] pause_flag Value to be assigned
    def pause_flag=(pause_flag)
      if !pause_flag.nil? && pause_flag.to_s.length < 1
        fail ArgumentError, 'invalid value for "pause_flag", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] face_payment_use_division Value to be assigned
    def face_payment_use_division=(face_payment_use_division)
      if !face_payment_use_division.nil? && face_payment_use_division.to_s.length < 1
        fail ArgumentError, 'invalid value for "face_payment_use_division", the character length must be great than or equal to 1.'
      end

      @face_payment_use_division = face_payment_use_division
    end
    ...
    def hash
      [store_id, store_code, store_name, store_abbr, print_receipt_store_name, print_stock_receipt_store_name, division, post_code, address, phone_number, fax_number, mail_address, homepage, temp_tran_mail_address, price_change_flag, sell_division, sum_proc_division, sum_date_change_time, sum_ref_column, point_not_applicable, tax_free_division, max_bundle_product_count, max_discount_rate, carriage_display_flag, terminal_adjustment_cash_flag, terminal_check_cash_flag, waiter_adjustment_division, saving_auto_division, saving_auto_price, cancel_setting_division, rounding_division, discount_rounding_division, card_company_select_division, gift_receipt_valid_days, tax_label_normal, tax_label_reduce, pause_flag, display_sequence, face_payment_use_division, ins_date_time, upd_date_time, point_condition, receipt_print_info].hash
    end
