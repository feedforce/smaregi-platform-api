  ...
  class GetCustomersItem
    ...
    def self.openapi_types
      {
        ...
        :'company_name' => :'AnyType',
        :'department_name' => :'AnyType',
        :'managerial_position' => :'AnyType',
        :'sex' => :'Sex',
        :'birth_date' => :'AnyType',
        :'point_expire_date' => :'AnyType',
        :'last_come_date_time' => :'AnyType',
        :'entry_date' => :'AnyType',
        :'leave_date' => :'String',
        :'point_giving_unit_price' => :'AnyType',
        :'point_giving_unit' => :'AnyType',
        :'pin_code' => :'AnyType',
        :'passport_no' => :'AnyType',
        :'nationality' => :'AnyType',
        :'alphabet_name' => :'AnyType',
        :'mail_receive_flag' => :'MailReceiveFlag',
        :'note' => :'AnyType',
        :'note2' => :'AnyType',
        :'favorite_list' => :'AnyType',
        :'browsing_list' => :'AnyType',
        :'status' => :'Status',
        :'store_id' => :'AnyType',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GetCustomersItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GetCustomersItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @mail_receive_flag.nil?
        invalid_properties.push('invalid value for "mail_receive_flag", mail_receive_flag cannot be nil.')
      end
      ...
      if @ins_date_time.nil?
        invalid_properties.push('invalid value for "ins_date_time", ins_date_time cannot be nil.')
      end

      if @ins_date_time.to_s.length < 1
        invalid_properties.push('invalid value for "ins_date_time", the character length must be great than or equal to 1.')
      end

      if @upd_date_time.nil?
        invalid_properties.push('invalid value for "upd_date_time", upd_date_time cannot be nil.')
      end

      if @upd_date_time.to_s.length < 1
    ...
    def valid?
      ...
      return false if @mail_receive_flag.nil?
      return false if @status.nil?
      return false if @ins_date_time.nil?
      return false if @ins_date_time.to_s.length < 1
      return false if @upd_date_time.nil?
      return false if @upd_date_time.to_s.length < 1
      true
    end
    ...
    def ins_date_time=(ins_date_time)
      if ins_date_time.nil?
        fail ArgumentError, 'ins_date_time cannot be nil'
      end
    ...
    def upd_date_time=(upd_date_time)
      if upd_date_time.nil?
        fail ArgumentError, 'upd_date_time cannot be nil'
      end
